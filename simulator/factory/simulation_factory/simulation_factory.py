...
class SimulationFactory:
    ...
    def get_simulation_handler(geometry_handler, compartments=None):
        ...
        compartments : list, optional
            A list of compartment models generated by the factory to preload in the handler
    ...
    def generate_gradient_profile(
        ...
        ----------
        bvals : list(float)
            List of b-values (must be the same length as the gradient vectors list)
        ...
        g_type : AcquisitionType, optional
            Type of sequence to simulate (see AcquisitionType enum), default : AcquisitionType.STEJSKAL_TANNER
        g_type_args :
            Positional arguments needed to initialize the sequence type (see .parameters.GradientProfile)
        g_type_kwargs :
            Named arguments needed to initialize the sequence type (see .parameters.GradientProfile)
    ...
    def generate_motion_model(randomize=False, direction_indexes="random", rotation=(0, 0, 0), translation=(0, 0, 0)):
        ...
        direction_indexes : list(int) or str, optional
            Either the indexes of the volumes to affect by motion, or "random", default : "random"
    ...
    def generate_fiber_stick_compartment(diffusivity, t1, t2, compartment_type):
        ...
        compartment_type : CompartmentType
            Simulation compartment to which links the model (see CompartmentType enum)
